...
- (UIButton *)videoButton {
    if (!_videoButton) {
        ...
        _videoButton.backgroundColor = [UIColor colorWithRed:29/255.0 green:214/255.0 blue:87/255.0 alpha:1.f];
...
- (UIButton *)scalingButton {
    if (!_scalingButton) {
        ...
        _scalingButton.backgroundColor = [UIColor colorWithRed:29/255.0 green:214/255.0 blue:87/255.0 alpha:1.f];
...
- (void)updateTopViewFrame {
    if (self.currentSession.isAudioOnly) {
        ...
        CGFloat containerHeight = self.view.bounds.size.height;
         ...
         self.portraitView.frame = CGRectMake((containerWidth-116)/2, (containerHeight - 40)/2 - 20 - 116, 116, 116);;
        
        self.userNameLabel.frame = CGRectMake((containerWidth - 240)/2, (containerHeight - 40)/2, 240, 40);
        self.userNameLabel.font = [UIFont systemFontOfSize:32];
        self.userNameLabel.textAlignment = NSTextAlignmentCenter;
        
        self.stateLabel.frame = CGRectMake((containerWidth - 240)/2, (containerHeight - 40)/2 + 40 + 13, 240, 15);

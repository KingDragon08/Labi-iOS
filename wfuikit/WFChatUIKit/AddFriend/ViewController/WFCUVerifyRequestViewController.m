...
- (void)viewDidLoad {
    ...
    self.verifyField = [[UITextField alloc] initWithFrame:CGRectMake(20, 32 + kStatusBarAndNavigationBarHeight, clientArea.size.width - 20, 54)];
    UIView *left = [[UIView alloc] initWithFrame:CGRectMake(0, 32 + kStatusBarAndNavigationBarHeight, 20, 54)];
    ...
    self.verifyField.font = [UIFont systemFontOfSize:17];

...
- (void)setModel:(WFCUMessageModel *)model {
    ...
    if (model.message.direction == MessageDirection_Send) {
        ...
        self.durationLabel.frame = CGRectMake(bounds.size.width - 48, 10, 18, 9);
        self.unplayedView.hidden = YES;
    } else {
        self.voiceBtn.frame = CGRectMake(4, 4, 22, 22);
        self.durationLabel.frame = CGRectMake(32, 10, 18, 9);
...
- (UIView *)unplayedView {
    if (!_unplayedView) {
        ...
        _unplayedView.backgroundColor = [UIColor colorWithRed:230/255.0 green:32/255.0 blue:32/255.0 alpha:1.0];

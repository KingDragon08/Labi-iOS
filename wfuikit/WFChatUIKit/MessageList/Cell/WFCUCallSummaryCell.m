...
- (void)setModel:(WFCUMessageModel *)model {
    ...
    if (model.message.direction == MessageDirection_Send) {
        ...
        self.modeImageView.frame = CGRectMake(width - 25, 5, 21, 21);
    } else {
        self.infoLabel.frame = CGRectMake(25,0, 70, 30);
        self.modeImageView.frame = CGRectMake(0, 5, 21, 21);
    }
    if ([self.model.message.content isKindOfClass:[WFCCCallStartMessageContent class]]) {
        ...
        self.infoLabel.text = startContent.getEndReason;
    }
}

...
- (void)setModel:(WFCUMessageModel *)model {
  ...
  if (model.showTimeLabel) {
    if (self.timeLabel == nil) {
      ...
      _timeLabel.textColor = [UIColor colorWithRed:165/255.0 green:166/255.0 blue:167/255.0 alpha:1.0];
    ...
    CGRect rect = CGRectMake((screenWidth - size.width)/2, 2, size.width, size.height);

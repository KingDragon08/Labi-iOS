    ...
    if (groupSearchInfo.marchType > 0) {
        ...
        for (NSString *memberId in groupSearchInfo.marchedMemberNames) {
            ...
            if (userInfo) {
                ...
                [string addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithRed:29/255.0 green:214/255.0 blue:87/255.0 alpha:1.f] range:NSMakeRange(0, string.length)];

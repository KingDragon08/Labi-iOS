...
- (void)viewDidLoad {
    ...
    [self.combineHeadView setBackgroundColor:HEXCOLOR(0xD2D8D9)];
  ...
  if(self.isModifyPortrait) {
    ...
    [self.resetBtn setBackgroundColor:[UIColor colorWithRed:29/255.0 green:214/255.0 blue:87/255.0 alpha:1.f]];
    ...
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(namePadding+20, 80 + portraitWidth + 60 + 24, bound.size.width - namePadding - namePadding - 40, 1)];
    [line setBackgroundColor:WFCCUtilities.onePxLineColor];

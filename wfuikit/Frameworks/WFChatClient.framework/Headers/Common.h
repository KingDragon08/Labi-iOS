 ...
 * 系统消息类型中100以下为常用基本类型消息。100-199位群聊消息类型。400-499为VoIP消息类型.
 */
//基本消息类型
//未知类型的消息
...
/// 单发红包
#define MESSAGE_CONTENT_TYPE_LUCKYMONEY 2001
/// 转账红包
#define MESSAGE_CONTENT_TYPE_TRANSFERMONEY 2003
/// 领取单发红包
#define MESSAGE_CONTENT_TYPE_LUCKYMONEY_ACCEPT_SINGLE 3001
/// 领取转账
#define MESSAGE_CONTENT_TYPE_TRANSFERMONEY_ACCEPT 3003

/// 群组红包
#define MESSAGE_CONTENT_TYPE_LUCKYMONEY_AGROUP 2002
/// 领取群组发红包
#define MESSAGE_CONTENT_TYPE_LUCKYMONEY_ACCEPT_AGROUP 3002

...
//    [self.view addSubview:_bottomItemsView];
    ...
    _btnFlash.bounds = CGRectMake(0, 0, 44, 44);
    _btnFlash.center = CGPointMake(CGRectGetWidth(_bottomItemsView.frame)/2, CGRectGetHeight(_bottomItemsView.frame)/2);
     [_btnFlash setImage:[UIImage imageNamed:@"CodeScan.bundle/ScanLowLight"] forState:UIControlStateNormal];
    [_btnFlash setImage:[UIImage imageNamed:@"CodeScan.bundle/ScanLowLight_HL"] forState:UIControlStateSelected];
    [_btnFlash setTitle:@"轻触照亮" forState:UIControlStateNormal];
    [_btnFlash setTitle:@"轻触关闭" forState:UIControlStateSelected];
    _btnFlash.titleEdgeInsets = UIEdgeInsetsMake(30, -10, 0, 0);
    _btnFlash.imageEdgeInsets = UIEdgeInsetsMake(-10, 18, 0, 0);
    [_btnFlash addTarget:self action:@selector(openOrCloseFlash) forControlEvents:UIControlEventTouchUpInside];
    [_btnFlash setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    _btnFlash.titleLabel.font = [UIFont systemFontOfSize:13];
    
    self.btnMyQR = [[UIButton alloc]init];
    [_btnMyQR setTitleColor:WFCCUtilities.wechatGreenColor forState:UIControlStateNormal];
    [_btnMyQR setTitleColor:WFCCUtilities.wechatGreenColor forState:UIControlStateSelected];
    _btnMyQR.titleLabel.font = [UIFont systemFontOfSize:13];
    [_btnMyQR setTitle:@"我的二维码" forState:UIControlStateNormal];
    ...
    [_btnPhoto setTitle:@"相册" forState:UIControlStateSelected];
    [_btnPhoto setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    _btnPhoto.titleLabel.font = [UIFont systemFontOfSize:15.0];
    _btnPhoto.frame = CGRectMake(0, 0, 44, 44);
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:_btnPhoto];
    ...
    CGFloat bWidth = 66;
    _btnFlash.frame = CGRectMake((width - bWidth)/2 ,YMaxRetangle - 65 , bWidth, bWidth);
    _btnMyQR.frame = CGRectMake((width - 100)/2, YMaxRetangle + 15, 100, 30);
    
    [self.view addSubview:_btnFlash];
    [self.view addSubview:_btnMyQR];
...
//
//    self.btnMyQR = [[UIButton alloc]init];
//    [_btnMyQR setTintColor:WFCCUtilities.wechatGreenColor];
//    [_btnMyQR setTitle:@"我的二维码" forState:UIControlStateNormal];
//    _btnMyQR.frame =
...
- (void)openOrCloseFlash
{
    ...
    [self.btnFlash setSelected:!self.btnFlash.isSelected];
}
